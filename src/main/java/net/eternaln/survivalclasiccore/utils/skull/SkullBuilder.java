package net.eternaln.survivalclasiccore.utils.skull;
...
public class SkullBuilder {
    ...
    public SkullBuilder setLore(List<String> lore) {
        this.lore = Utils.formatList(lore);
    ...
    public ItemStack toItemStack() {
        ...
        if (displayName != null) {
            skullMeta.setDisplayName(Utils.ct(displayName));
        }

        if (lore != null) {
            skullMeta.setLore(Utils.formatList(lore));
        }
